...
export function PlaceholderSection({ title, subtitle, description }: PlaceholderSectionProps) {
  return (
    <div>
      {/* Header */}
      ...
      <div className="p-8 max-w-[1600px]">
        ...
        >
          ...
          <p className="text-sm text-[var(--edu-text-secondary)] max-w-lg mx-auto leading-relaxed">
            {description}
          </p>
